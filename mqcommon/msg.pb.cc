...
const uint32_t TableStruct_msg_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::WY::BasicProperties, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::WY::BasicProperties, id_),
  PROTOBUF_FIELD_OFFSET(::WY::BasicProperties, delivery_mode_),
  PROTOBUF_FIELD_OFFSET(::WY::BasicProperties, routing_key_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::WY::Message_Payload, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::WY::Message_Payload, properties_),
  PROTOBUF_FIELD_OFFSET(::WY::Message_Payload, body_),
  PROTOBUF_FIELD_OFFSET(::WY::Message_Payload, valid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::WY::Message, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::WY::Message, paylaod_),
  PROTOBUF_FIELD_OFFSET(::WY::Message, offset_),
  PROTOBUF_FIELD_OFFSET(::WY::Message, length_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::WY::BasicProperties)},
  { 9, -1, -1, sizeof(::WY::Message_Payload)},
  { 18, -1, -1, sizeof(::WY::Message)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::WY::_BasicProperties_default_instance_._instance,
  &::WY::_Message_Payload_default_instance_._instance,
  &::WY::_Message_default_instance_._instance,
};

const char descriptor_table_protodef_msg_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\tmsg.proto\022\002WY\"[\n\017BasicProperties\022\n\n\002id"
  "\030\001 \001(\t\022\'\n\rdelivery_mode\030\002 \001(\0162\020.WY.Deliv"
  "eryMode\022\023\n\013routing_key\030\003 \001(\t\"\240\001\n\007Message"
  "\022$\n\007paylaod\030\001 \001(\0132\023.WY.Message.Payload\022\016"
  "\n\006offset\030\002 \001(\r\022\016\n\006length\030\003 \001(\r\032O\n\007Payloa"
  "d\022\'\n\nproperties\030\001 \001(\0132\023.WY.BasicProperti"
  "es\022\014\n\004body\030\002 \001(\t\022\r\n\005valid\030\003 \001(\t*A\n\014Excha"
  "ngeType\022\016\n\nUNKNOWTYPE\020\000\022\n\n\006DIRECT\020\001\022\n\n\006F"
  "ANOUT\020\002\022\t\n\005TOPIC\020\003*:\n\014DeliveryMode\022\016\n\nUN"
  "KNOWMODE\020\000\022\r\n\tUNDURABLE\020\001\022\013\n\007DURABLE\020\002b\006"
  "proto3"
  ;
static ::_pbi::once_flag descriptor_table_msg_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_msg_2eproto = {
    false, false, 406, descriptor_table_protodef_msg_2eproto,
    "msg.proto",
...
BasicProperties::BasicProperties(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:WY.BasicProperties)
}
BasicProperties::BasicProperties(const BasicProperties& from)
  ...
  // @@protoc_insertion_point(copy_constructor:WY.BasicProperties)
}
...
BasicProperties::~BasicProperties() {
  // @@protoc_insertion_point(destructor:WY.BasicProperties)
...
// @@protoc_insertion_point(message_clear_start:WY.BasicProperties)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "WY.BasicProperties.id"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          CHK_(ptr);
          _internal_set_delivery_mode(static_cast<::WY::DeliveryMode>(val));
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "WY.BasicProperties.routing_key"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* BasicProperties::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:WY.BasicProperties)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_routing_key().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "WY.BasicProperties.routing_key");
    target = stream->WriteStringMaybeAliased(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:WY.BasicProperties)
  return target;
}

size_t BasicProperties::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:WY.BasicProperties)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:WY.BasicProperties)
...
// @@protoc_insertion_point(class_specific_copy_from_start:WY.BasicProperties)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Message_Payload::_Internal {
 public:
  static const ::WY::BasicProperties& properties(const Message_Payload* msg);
};
...
Message_Payload::Message_Payload(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:WY.Message.Payload)
}
Message_Payload::Message_Payload(const Message_Payload& from)
  ...
  // @@protoc_insertion_point(copy_constructor:WY.Message.Payload)
}
...
Message_Payload::~Message_Payload() {
  // @@protoc_insertion_point(destructor:WY.Message.Payload)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:WY.Message.Payload)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "WY.Message.Payload.body"));
        } else
          goto handle_unusual;
        continue;
      // string valid = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "WY.Message.Payload.valid"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Message_Payload::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:WY.Message.Payload)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:WY.Message.Payload)
  return target;
}

size_t Message_Payload::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:WY.Message.Payload)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:WY.Message.Payload)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:WY.Message.Payload)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
class Message::_Internal {
 public:
  static const ::WY::Message_Payload& paylaod(const Message* msg);
};

const ::WY::Message_Payload&
Message::_Internal::paylaod(const Message* msg) {
  return *msg->paylaod_;
}
Message::Message(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor();
  // @@protoc_insertion_point(arena_constructor:WY.Message)
}
Message::Message(const Message& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  if (from._internal_has_paylaod()) {
    paylaod_ = new ::WY::Message_Payload(*from.paylaod_);
  } else {
    paylaod_ = nullptr;
  }
  ...
  // @@protoc_insertion_point(copy_constructor:WY.Message)
}

inline void Message::SharedCtor() {
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&paylaod_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&length_) -
    reinterpret_cast<char*>(&paylaod_)) + sizeof(length_));
}

Message::~Message() {
  // @@protoc_insertion_point(destructor:WY.Message)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void Message::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  if (this != internal_default_instance()) delete paylaod_;
}
...
void Message::Clear() {
// @@protoc_insertion_point(message_clear_start:WY.Message)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr = ctx->ParseMessage(_internal_mutable_paylaod(), ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* Message::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:WY.Message)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  // .WY.Message.Payload paylaod = 1;
  if (this->_internal_has_paylaod()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(1, _Internal::paylaod(this),
        _Internal::paylaod(this).GetCachedSize(), target, stream);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:WY.Message)
  return target;
}

size_t Message::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:WY.Message)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:WY.Message)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (from._internal_has_paylaod()) {
    _internal_mutable_paylaod()->::WY::Message_Payload::MergeFrom(from._internal_paylaod());
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:WY.Message)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Message::InternalSwap(Message* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(Message, paylaod_)>(
          reinterpret_cast<char*>(&paylaod_),
          reinterpret_cast<char*>(&other->paylaod_));
}
...
template<> PROTOBUF_NOINLINE ::WY::BasicProperties*
Arena::CreateMaybeMessage< ::WY::BasicProperties >(Arena* arena) {
  return Arena::CreateMessageInternal< ::WY::BasicProperties >(arena);
}
template<> PROTOBUF_NOINLINE ::WY::Message_Payload*
Arena::CreateMaybeMessage< ::WY::Message_Payload >(Arena* arena) {
  return Arena::CreateMessageInternal< ::WY::Message_Payload >(arena);
}
template<> PROTOBUF_NOINLINE ::WY::Message*
Arena::CreateMaybeMessage< ::WY::Message >(Arena* arena) {
  return Arena::CreateMessageInternal< ::WY::Message >(arena);
}
